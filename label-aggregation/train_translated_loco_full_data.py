...
def main():
    ...
    for country_idx in tqdm(range(len(countries)), desc=f'Test countries'):
        ...
        if rile_strict:
            ...
            log_file_name = 'results_full_data_translated_loco_mpnet_RILE_strict.log'
        elif rile_only:
            rile_dict = utils.get_rile_categories()
            ...
            train_data.insert(0, 'label', new_train_labels)
            test_data.insert(0, 'label', new_test_labels)
            log_file_name = 'results_full_data_translated_loco_mpnet_RILE_only.log'
        else:
            log_file_name = 'results_full_data_translated_loco_mpnet.log'
        ...
        classification_head = ClassificationHead(
            input_dim=768,  # Always 768 with LOCO
            out_dim=n_classes)
