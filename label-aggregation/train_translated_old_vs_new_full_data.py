...
def main():
    ...
    # We will be predicting the last three years, 2019–2021, 
    ...
    rile_strict = False               # Only three labels
    rile_only = rile_strict or False  # All relevant labels
    if rile_strict:
        ...
        log_file_name = 'results_full_data_old_vs_new_xlm_roberta_large_RILE_strict.log'
    elif rile_only:
        rile_dict = utils.get_rile_categories()
        ...
        train_data.insert(0, 'label', new_train_labels)
        test_data.insert(0, 'label', new_test_labels)
        log_file_name = 'results_full_data_old_vs_new_xlm_roberta_large_RILE_only.log'
    else:
        log_file_name = 'results_full_data_old_vs_new_xlm_roberta_large.log'
